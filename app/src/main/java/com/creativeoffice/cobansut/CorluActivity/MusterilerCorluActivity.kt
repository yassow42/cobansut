...
import kotlinx.android.synthetic.main.activity_musteriler_corlu.*
                ...
                refCorlu.child("Musteriler").child(arananMusteriAdi).addListenerForSingleValueEvent(object : ValueEventListener {
                    ...
                    override fun onDataChange(p0: DataSnapshot) {
                        ...
                        if (p0.hasChildren()) {
                            ...
                            dialogViewSpArama = View.inflate(this@MusterilerCorluActivity, R.layout.dialog_siparis_ekle, null)
