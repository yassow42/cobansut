...
class HaritaActivity : AppCompatActivity(), OnMapReadyCallback {
                ...
                if (gelenData.siparis_teslim_tarihi != null) {
                    if (gelenData.siparis_teslim_tarihi!!.compareTo(System.currentTimeMillis()) == -1) {
                        ...
                        if (konumVarMi) {
                            ...
                            myMarker.title = gelenData.siparis_mah
                            myMarker.isFlat = true
                           ...
                           if (gelenData.siparis_mah != "Market") {
                                try {
                                    ...
                                    val adres = LatLng(lat, long)
                                    Log.e("lat long", " $adres $lat /// $long")

                                    mMap.addCircle(
                                        CircleOptions().center(adres).radius(85.0).strokeWidth(6f).strokeColor(Color.BLUE).fillColor(
                                    ...
                                    Log.e("HaritaActivity", "131. satır " + e.message.toString())
      ...
      /*  refBolge.child("Siparisler").addListenerForSingleValueEvent(object : ValueEventListener {
            ...
            override fun onDataChange(p0: DataSnapshot) {
                if (p0.hasChildren()) {
                    ...
                    Log.e("siparisListesiSayisi", Utils.siparisList.size.toString())
    ...
    fun convertAddressLat(adres: String): Double? {
        var geoCoder = Geocoder(this)
            ...
            val addressList: List<Address> = geoCoder.getFromLocationName(adres.toString(), 1)
